...
import CareerContents from "./_components/career-contents";
...
export default function CareerPage() {
  ...
  return (
    <LenisWrap>
      <>
        <div className="w-full h-screen bg-white mb-12 md:mb-0">
          <div className="mx-auto responsiveWidth">
            <MenuHeader title="CAREER" />
          </div>
          ...
          >
            <MenuCover img="/images/career/career-bg.png" opacity={opacity} />
          </div>
          <div
          ...
          >
            <ScrollDownButton color="black" nextSectionId="career-contents" />
          </div>
        </div>
        <CareerContents />
      </>
