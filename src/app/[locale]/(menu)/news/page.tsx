...
import NewsGallery from "./_sections/news-gallery";
    ...
    <LenisWrap>
      <>
        <div className="w-full h-screen bg-white mb-28 xl:mb-40">
          ...
          >
            <MenuCover img="/images/news/news-image.png" opacity={opacity} />
          </div>
          <div
          ...
          >
            <ScrollDownButton color="black" nextSectionId="news-gallery" />
          </div>
        </div>
        <MenuWrapper>
          <>
