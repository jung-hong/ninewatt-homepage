...
import SubHeader from "./_sections/sub-header";
import NinewattPerformance from "./_sections/ninewatt-performance";
import NinewattPatent from "./_sections/ninewatt-patent";
    ...
    <LenisWrap>
      <>
        <div className="w-full h-screen bg-white mb-28 xl:mb-40">
          ...
          >
            <MenuCover
              img="/images/portfolio/portfolio-image.png"
              opacity={opacity}
              isLogoWhite={true}
            />
          </div>
          ...
          >
            <ScrollDownButton
              ...
              nextSectionId="portfolio-subheader"
            />
          </div>
        </div>
        <MenuWrapper>
        ...
        <div className="w-full py-14 md:py-[160px] bg-gray50">
          <NinewattPatent />
        </div>
      </>
    </LenisWrap>
